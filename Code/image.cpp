...
ImageClass *Image;	//	ëSÇƒÇÃâÊñ èàóùprinter

ImageClass TitleBackground; //	TitleÇÃîwåi
ImageClass TitleLogo; //	TitleÇÃLOGO
ImageClass TitleInit; //	TitleÇÃíÒé¶

ImageClass Scren; //	îwåiÅiîwåiêFÅj
ImageClass Grass[64]; //	ínñ îwåi
ImageClass LandPixel[LANDPIXELMAX]; //	ínñ Åiñ{ï®Åj
ImageClass Footing[64];	//óéâ∫ì_
ImageClass XYZ;
